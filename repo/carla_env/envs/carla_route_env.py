...
class CarlaRouteEnv(gym.Env):
    ...
    def _get_observation_seg_bev(self):
        ...
        vehicle_bbox_list = (
            ...
            + self.world.get_level_bbs(carla.CityObjectLabel.Bus)
            + self.world.get_level_bbs(carla.CityObjectLabel.Truck)
            + self.world.get_level_bbs(carla.CityObjectLabel.Motorcycle)
            + self.world.get_level_bbs(carla.CityObjectLabel.Bicycle)
        )
